...
def main(args):
    ...
    if args.from_pretrained_0:
        ...
        if args.load_weight_type == 'full':
            ...
            filtered_dict = {k: v for k, v in checkpoint['model_state_dict'].items() if (k in model_dict) and ('encoders.' in k or 'seg_' in k or 'rec_' in k)}
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.training_stream == 'Upstream':
            ...
            if args.model_name == 'Up_SMART_Net':
                ...
                train_stats = train_Up_SMART_Net(model, criterion, data_loader_train, optimizer, device, epoch, args.print_freq, args.batch_size, args.freeze_feature_extractor)
            ...
            ## Single
                ...
                train_stats = train_Up_SMART_Net_Single_CLS(model, criterion, data_loader_train, optimizer, device, epoch, args.print_freq, args.batch_size, args.freeze_feature_extractor)
                print("Averaged train_stats: ", train_stats)
