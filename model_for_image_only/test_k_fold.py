    ...
    for idx in range(int(args.checkpoint_total_num)):
        ...
        if args.training_stream == 'Upstream':
            ...
            ## Dual    
                ...
                test_stats, cls_pred_prob_list, cls_gt_list = test_Up_SMART_Net_Dual_CLS_SEG(model, criterion, data_loader_test, device, args.print_freq, 1, args.output_dir, idx)
                total_probs.append(cls_pred_prob_list)
                ...
                test_stats, cls_pred_prob_list, cls_gt_list = test_Up_SMART_Net_Dual_SEG_REC(model, criterion, data_loader_test, device, args.print_freq, 1, args.output_dir, idx)
                total_probs.append(cls_pred_prob_list)
