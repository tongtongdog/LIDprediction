...
def main(args):
    ...
    if args.training_stream == 'Upstream':
        if args.model_name == 'Up_SMART_Net':
            ...
            infer_Up_SMART_Net_Single_CLS(model, data_loader_test, device, args.print_freq, args.output_dir)
        elif args.model_name == 'Up_SMART_Net_Dual_CLS_REC':
            infer_Up_SMART_Net_Dual_CLS_REC(model, data_loader_test, device, args.print_freq, args.output_dir)        
        else : 
